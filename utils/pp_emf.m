...
plot 'output/final.dat' u 1:($4 > 0 ? $4 * 1e9 : NaN):($2>0?$2:NaN) w points palette pt 7 notitle
...
set xrange [0:56]
set yrange [0.5:1]
plot 'output/final.dat' u 1:($5 > 0 ? $2/$5 : NaN):($2>0?$2:NaN) w points palette pt 7 notitle
...
plot 'output/final.dat' u 1:($6 > 1e-13 ? $6 * 1e12 : NaN):($2>0?$2:NaN) w points palette pt 7 notitle
