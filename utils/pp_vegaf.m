...
set xrange [0:56]
set logscale y
plot 'vegaf/final.dat' u 1:($4 > 1e-1 ? $4 * 1e-9 : NaN):($3>0?$3:NaN) w points palette pt 7 notitle
...
plot 'vegaf/final.dat' u 1:($5 > 1e-4 ? $5 * 1e-9 : NaN):($3>0?$3:NaN) w points palette pt 7 notitle
...
set yrange [0:30]
unset xlabel
plot 'vegaf/final.dat' u 1:($6 > 0 ? $6 * (180./3.141593) : NaN):($3>0?$3:NaN) w points palette pt 7 notitle
...
plot 'vegaf/final.dat' u 1:($7 > 0 ? $7 * (180./3.141593) : NaN):($3>0?$3:NaN) w points palette pt 7 notitle
...
plot 'vegaf/final.dat' u 1:($8 > 0 ? $8 * (180./3.141593) : NaN):($3>0?$3:NaN) w points palette pt 7 notitle
