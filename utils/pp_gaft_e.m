...
set xrange [0:56]
set logscale y
plot 'gaft/errors.dat' u 1:($4 > 0 ? $4 * 1e-9 : NaN):($5>0?$5 * 1e-9:NaN) w yerrorbars notitle
...
set ytics
set xrange [0:56]
plot 'gaft/errors.dat' u 1:($6 > 0 ? $6 *1e-9: NaN):($7>0?$7*1e-9:NaN) w yerrorbars notitle
...
set xrange [0:56]
plot 'gaft/errors.dat' u 1:($20 > 0 ? $20 : NaN):($21>0?$21:NaN) w yerrorbars notitle
...
plot 'gaft/errors.dat' u 1:($22 > 0 ? $22 : NaN):($23>0?$23:NaN) w yerrorbars notitle
