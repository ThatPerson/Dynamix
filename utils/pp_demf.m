...
plot 'demf/final.dat' u 1:($4 > 0 ? $4 * 1e9 : NaN):($3>0?$3:NaN) w points palette pt 7 notitle
...
plot 'demf/final.dat' u 1:($6 > 1e-13 ? $6 * 1e12 : NaN):($3>0?$3:NaN) w points palette pt 7 notitle
