...
set xrange [0:56]
set logscale y
plot 'egaft/errors.dat' u 1:($4 > 0 ? $4 * 1e-9 : NaN):($5>0?$5 * 1e-9:NaN) w yerrorbars notitle
...
set ytics
set xrange [0:56]
plot 'egaft/errors.dat' u 1:($6 > 0 ? $6 *1e-9: NaN):($7>0?$7*1e-9:NaN) w yerrorbars notitle
...
set xrange [0:56]
plot 'egaft/errors.dat' u 1:($16 > 0 ? $16 : NaN):($17>0?$17:NaN) w yerrorbars notitle
...
plot 'egaft/errors.dat' u 1:($18 > 0 ? $18 : NaN):($19>0?$19:NaN) w yerrorbars notitle
...
plot 'egaft/errors.dat' u 1:($8 > 0 ? $8 * (180./3.141593) : NaN):($9>0?$9* (180./3.141593):NaN) w yerrorbars notitle
...
plot 'egaft/errors.dat' u 1:($10 > 0 ? $10 * (180./3.141593) : NaN):($11>0?$11* (180./3.141593):NaN) w yerrorbars notitle
...
plot 'egaft/errors.dat' u 1:($12 > 0 ? $12 * (180./3.141593) : NaN):($13>0?$13* (180./3.141593):NaN) w yerrorbars notitle
...
plot 'egaft/errors.dat' u 1:($14 > 0 ? $14 : NaN):($15>0?$15* (180./3.141593):NaN) w yerrorbars notitle
