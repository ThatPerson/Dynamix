...
plot 'demf/errors.dat' u 1:($4 > 0 ? $4 * 1e9 : NaN):($5>0?$5*1e9:NaN) w yerrorbars  notitle
...
plot 'demf/errors.dat' u 1:($8 > 1e-13 ? $8 * 1e12 : NaN):($9>0?$9*1e12:NaN) w yerrorbars  notitle
