...
plot 'demft/errors.dat' u 1:($6 > 0 ? $6 : NaN):($7>0?$7:NaN) w yerrorbars notitle
...
plot 'demft/errors.dat' u 1:($4 > 0 ? $4 : NaN):($5>0?$5:NaN) w yerrorbars notitle
...
set xrange [0:56]
set yrange [0.5:1]
plot 'demft/errors.dat' u 1:($10 > 0 ? $10 : NaN):($11>0?$11:NaN) w yerrorbars notitle
...
set xrange [0:56]
#set yrange [0.1:1e3]
plot 'demft/errors.dat' u 1:($8 > 0 ? $8 : NaN):($9>0?$9:NaN) w yerrorbars notitle
...
set xtics (10, 20, 30, 40, 50)
plot 'demft/errors.dat' u 1:($14 > 0 ? $14 : NaN):($15>0?$15:NaN) w yerrorbars notitle
