	...
	for (sigs[0] = 0.05; sigs[0] <= 0.1; sigs[0] += 0.05) {
		for (sigs[1] = 0.05; sigs[1] <= 0.1; sigs[1] += 0.05) {
			for (sigs[2] = 0.05; sigs[2] <= 0.1; sigs[2] += 0.05) {
				...
				printf("\t\tGAF_ord_paramTT(%Lf, %Lf, %Lf,  %f, %f, %f, %f)\n", sigs[0], sigs[1], sigs[2], res->orients[OR_NH].phi, res->orients[OR_NH].theta, res->orients[OR_NH].phi, res->orients[OR_NH].theta);
				
				printf("\t[%f, %f] // [%f, %f]\n\t\t%f\n", res->orients[OR_NCSAxx].phi, res->orients[OR_NCSAxx].theta, res->orients[OR_NCSAxx].phi, res->orients[OR_NCSAxx].theta, S2NCSAxs);
				printf("\t\tGAF_ord_paramTT(%Lf, %Lf, %Lf,  %f, %f, %f, %f)\n", sigs[0], sigs[1], sigs[2], res->orients[OR_NCSAxx].phi, res->orients[OR_NCSAxx].theta, res->orients[OR_NCSAxx].phi, res->orients[OR_NCSAxx].theta);
				
				
				printf("\t[%f, %f] // [%f, %f]\n\t\t%f\n", res->orients[OR_NCSAyy].phi, res->orients[OR_NCSAyy].theta, res->orients[OR_NCSAyy].phi, res->orients[OR_NCSAyy].theta, S2NCSAys);
				printf("\t\tGAF_ord_paramTT(%Lf, %Lf, %Lf,  %f, %f, %f, %f)\n", sigs[0], sigs[1], sigs[2], res->orients[OR_NCSAyy].phi, res->orients[OR_NCSAyy].theta, res->orients[OR_NCSAyy].phi, res->orients[OR_NCSAyy].theta);
				
				printf("\t[%f, %f] // [%f, %f]\n\t\t%f\n", res->orients[OR_NCSAxx].phi, res->orients[OR_NCSAxx].theta, res->orients[OR_NCSAyy].phi, res->orients[OR_NCSAyy].theta, S2NCSAxys);
				printf("\t\tGAF_ord_paramTT(%Lf, %Lf, %Lf,  %f, %f, %f, %f)\n", sigs[0], sigs[1], sigs[2], res->orients[OR_NCSAxx].phi, res->orients[OR_NCSAxx].theta, res->orients[OR_NCSAyy].phi, res->orients[OR_NCSAyy].theta);
				
				printf("\t[%f, %f] // [%f, %f]\n\t\t%f\n", res->orients[OR_CN].phi, res->orients[OR_CN].theta, res->orients[OR_CN].phi, res->orients[OR_CN].theta, S2CNs);
				printf("\t\tGAF_ord_paramTT(%Lf, %Lf, %Lf,  %f, %f, %f, %f)\n", sigs[0], sigs[1], sigs[2], res->orients[OR_CN].phi, res->orients[OR_CN].theta, res->orients[OR_CN].phi, res->orients[OR_CN].theta);
				
				printf("\t[%f, %f] // [%f, %f]\n\t\t%f\n", res->orients[OR_NCA].phi, res->orients[OR_NCA].theta, res->orients[OR_NCA].phi, res->orients[OR_NCA].theta, S2CaNs);
				printf("\t\tGAF_ord_paramTT(%Lf, %Lf, %Lf,  %f, %f, %f, %f)\n", sigs[0], sigs[1], sigs[2], res->orients[OR_NCA].phi, res->orients[OR_NCA].theta, res->orients[OR_NCA].phi, res->orients[OR_NCA].theta);
				printf("\n\n");
